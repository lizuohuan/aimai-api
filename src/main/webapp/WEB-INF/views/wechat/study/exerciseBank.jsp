...
<script>
    ...
    function getDataList(pageNO, pageSize) {
        ...
        var dataList = null;
        CC.ajaxRequestData("post", false, "curriculum/queryCurriculumStudy", arr, function (result) {
        ...
        for(var i = 0; i < dataList.length; i++) {
            ...
            html += '<li class="mui-table-view-cell mui-media">' +
                    '   <a href="' + CC.ip + '/page/exerciseList?curriculumId=' + obj.id + '&orderId=' + obj.orderId + '" class="mui-navigate-right">' +
