...
<body ng-app="webApp" ng-controller="registerPhoneController" ng-cloak>
...
<div class="mui-content">
    ...
    <div class="mui-input-row mui-checkbox mui-left">
        ...
        <a href="<%=request.getContextPath()%>/page/app/agreement" class="agreement-btn">用户条款和隐私政策</a>
    </div>
...
<script>
    ...
    webApp.controller('registerPhoneController', function($scope, $http, $timeout) {
        $scope.registerType = CC.getUrlParam("registerType"); //获取注册类型
        ...
        $scope.nextStep = function() {
            ...
            if($scope.isPhone) {
                ...
                localStorage.setItem("registerInfo", JSON.stringify(json));
                location.href = CC.ip + "page/registerPassword";
            } else {
                mui.alert("手机号错误.");
            }
        ...
        $scope.sendCode = function() {
            ...
            $.ajax({
                type: "POST",
                url: CC.ip + "user/sendMessageRegister",
                data: {
                    phone: $phone
                },
